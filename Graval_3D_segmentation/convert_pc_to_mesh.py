...
pcd = o3d.io.read_point_cloud(
    filename="/home/cplus/projects/m.tarek_master/graval_detection_3D/point_cloud_segmentation/plys/rec_scaled_ascii.ply",
    print_progress=True)
...
cl, ind = pcd_rotated.remove_statistical_outlier(nb_neighbors=10,std_ratio=2.0)
